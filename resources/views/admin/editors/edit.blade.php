...
@section('content')
    <div class="container d-flex flex-column" style="height: calc(100vh - 6rem);">
        <div class="row pb-3 pt-3 flex-grow-0">
            <div class="col-12">
                <h1 class="text-center">Modifica un Editore</h1>
            </div>
        </div>
            ...
            <div class="col-md-8 col-sm-10 col-12">
                <form method="POST" action="{{ route('admin.editors.update', $editor->id) }}">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="name" name="name" value="{{ old('name', $editor->name) }}" required>
                        @error('name')
                    ...
                    <button type="submit" id="submit" class="btn btn-primary mt-3 mb-5">Aggiorna Editore</button>
                </form>
            </div>
        </div>
    </div>
