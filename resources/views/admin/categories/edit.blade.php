...
@section('content')
    <div class="container d-flex flex-column" style="height: calc(100vh - 6rem);">
        <div class="row pb-3 pt-3 flex-grow-0">
            <div class="col-12">
                <h1 class="text-center">Modifica una Categoria</h1>
            </div>
        </div>
        ...
        <div class="row justify-content-center flex-grow-1" style="margin-top: 5rem">
            <div class="col-md-8 col-sm-10 col-12">
                <form method="POST" action="{{ route('admin.categories.update', $category->id) }}">
                    ...
                    {{-- Nome Editore --}}
                    <div class="mb-3">
                        <label class="form-label fw-bold">Nome della Categoria *</label>
                    ...
                    <button type="submit" id="submit" class="btn btn-primary mt-3 mb-5">Aggiorna Categoria</button>
                </form>
            </div>
        </div>
    </div>
