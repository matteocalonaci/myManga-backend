...
<div class="container d-flex flex-column" style="height: calc(100vh - 6rem);">
    <div class="row pb-3 pt-3 flex-grow-0">
            <div class="col-12">
                <h1 class="text-center">Aggiungi un Categoria</h1>
            </div>
        </div>
        ...
        <div class="row justify-content-center flex-grow-1" style="margin-top: 5rem">
            <div class="col-md-8 col-sm-10 col-12">
                <form method="POST" action="{{ route('admin.categories.store') }}">
                    ...
                    {{-- Nome Categoria --}}
                    <div class="mb-3">
                        <label class="form-label fw-bold">Nome dell'Categoria *</label>
                    ...
                    <button type="submit" id="submit" class="btn btn-primary mt-3 mb-5">Aggiungi Categoria</button>
                </form>
            </div>
        </div>
    </div>
