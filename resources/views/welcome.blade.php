        ...
        <div class="col-md-4">
            <div class="card mb-4">
                ...
                <div class="card-body">
                    ...
                    <p class="card-text">La sedicenne Ai Hoshino è una bellissima idol, molto amata dai suoi fan. Ai sembra la personificazione della ragazza perfetta, ma non è tutto oro ciò che luccica...</p>
        ...
        <div class="col-md-4">
            <div class="card mb-4">
                ...
                <div class="card-body">
                    ...
                    <p class="card-text">Hiroto Ikuta, ventinove anni, non ha un lavoro fisso, vita amorosa, né alcuna preoccupazione per il futuro...",
                    </p>
        ...
        <div class="col-md-4">
            <div class="card mb-4">
                ...
                <div class="card-body">
                    ...
                    <p class="card-text">Kazuhiro, un padre di famiglia 42enne, e il giovane motociclista Takuya si scontrano in un incidente stradale in una notte d’estate...</p>
